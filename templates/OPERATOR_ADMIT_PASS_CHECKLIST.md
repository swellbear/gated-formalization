# Operator admit-pass checklist (9 steps)

Paste into the ADMIT chat or docs-fold PR. Same pass: Softened SoT **then** docs fold. Full text: [`docs/operator_ops/ADMIT_PASS_CHECKLIST.md`](../docs/operator_ops/ADMIT_PASS_CHECKLIST.md). Habit §E–H: [`docs/OPERATOR_SOFTEN_FOLD_HABIT.md`](../docs/OPERATOR_SOFTEN_FOLD_HABIT.md).

- [ ] **1. Read** stamp + `SOFTENED_SET.md` + idle latch before any admit language.
- [ ] **2. Name** the board (dated record / PROPOSED / park) and the Founder call (GO / reject / still open).
- [ ] **3. Classify** ADMITTED / REJECTED / PARKED / HOLD Soften. HOLD Soften **only** if the Founder call is still open.
- [ ] **4. Idle:** if ON, new Lab PROPOSED → REJECT idle-breach (**not Softened**). Soften Hard NO. Do not clear idle.
