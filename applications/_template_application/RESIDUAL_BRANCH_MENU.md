...
## 2. Cards (one per residual — required fields)

Use explicit HTML anchors so links work reliably: `<a id="r-example"></a>`.
...
**If none empirically resolvable:** State **No empirically resolvable residuals** and still card the parked/normative items briefly.
...
*(Also give each a card in §2 with Class = Definition-blocked.)*
