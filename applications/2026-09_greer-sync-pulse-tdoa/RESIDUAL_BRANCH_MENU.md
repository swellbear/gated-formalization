...
| A3-indoor-first-arrival | Indoor / first-arrival / denied-box radio (not our additive mild-NLOS Soften) | Scored Soften | **Soften** — last check: 2026-09-05 Operator **ADMIT** (suite gate); mild/intermittent LE only for ≤1 m; persistent B_lb fails |
...
| 2026-09-05 | Operator **ADMIT A2 Soften-conditional** (suite gate). JOINT1+~2.5 ns Soften; **Kill** bare Chan at ~2.5 ns (~**1.14 m** ≫ X); **Kill** commodity **20–50 ns** / common-view **~10 ns** / absolute-only **~5–15 ns** for both curves; Harden unsupported. Brutal lock: patent simultaneous-via-DGPS-1PPS ≠ commercial 1PPS. Individual SCORE may land from the A2 fold. |
| 2026-09-05 | Operator **ADMIT A3 Soften** (suite gate). Mild/intermittent LE only for **≤1 m**. Persistent **B_lb** fails. Individual SCORE may land from the A3 fold. |
