...
Stay the **same Amb**. Do **not** unpark hardware **X**. Do **not** train. Do **not** copy patent claims. Do **not** claim a multipath-robust or drift-robust 0.50 m. After JOINT1, next named pulse is **DRIFT1**.
