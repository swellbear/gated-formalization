# Companion dog/cat BIA → weight — reading guide
...
2. [`NAMED_GAP_LEDGER.md`](NAMED_GAP_LEDGER.md) — Soften + DATA-BLOCKED lines
3. [`PROPOSED_HUNT.md`](PROPOSED_HUNT.md) — Lab hunt summary + Operator/Founder gate
4. [`TAMURA_INSPECT.md`](TAMURA_INSPECT.md) — Tamura 2026 inspected-fail summary
