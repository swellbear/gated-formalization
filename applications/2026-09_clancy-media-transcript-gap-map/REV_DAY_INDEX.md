...
This index names **which pages are live / not-found / 404**. It does **not** dump those days. Softened set after Day 13 fold = **2–13, 14, 18**. Softened Days 2–12 + 14 + 18 boards **untouched**. Soften Critic **not hired**.
...
**Index expand ≠ all-days dump.** **Index expand ≠ Soften of remaining live days 15–17, 19–21.** Standing GO continues **named-day pulses** (C3 class; Lab invent/hand **Day 15** next) across this Digestor index. **Hold C2 / C4.**
...
| Day 13 | day | https://www.rev.com/transcripts/ma-v-lindsay-clancy-day-13 | **live** | **Softened** — C3 Day 13 cyber-forensic-examiner backup |
...
| Set | Days | Status |
|-----|------|--------|
| **Softened** | **2–13, 14, 18** | Named-day backups poseable. Softened Days 2–12 + 14 + 18 **ADMITTED** (not PROPOSED). **Day≠certified.** Softened Days 2–12 / 14 / 18 boards **untouched** this fold. |
| **Indexed, not Softened** | 15–17, 19–21 | Live media pages. Standing GO = Lab invent/hand **Day 15** next, then remaining days one at a time. |
