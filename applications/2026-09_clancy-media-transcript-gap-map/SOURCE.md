...
**Role:** notes summary. Operator **ADMIT Soften S0** locks the board as poseable/citable — [`DIGESTION_S0.md`](DIGESTION_S0.md). Later same day: Soften C1 + Soften C3 + Soften C3 Day 14 + Soften C3 Day 13 #120 + Soften C3 Day 16 #122 + Soften C3 Day 21 #126 + **Soften C3 Day 6** this fold + **Digestor index expand** + **Digestor INTERIM mid-run** snapshot (**not** converted to park here). **NOT** Soften of the parent usefulness claim. **Success bar unset.** **NOT** Soften of any Day 6 line as certified trial fact. **LOUD: bottle inventory ≠ Soften meds-cause or guilt.** **NOT** Soften of any Day 21 line / Saathoff CR as certified fact. **Saathoff CR ≠ Soften of capacity / guilt / CR as certified.** **LOUD media≠certified.** Day 1 missing / Days 22+ 404 = corpus **EDGE**. Softened set: **2–21**. **LAST Digestor live day Softened.** Digestor park DIGEST **already on master #124 (this Soften PR does NOT write/rewrite it)**.  
...
| Day 17 | day | https://www.rev.com/transcripts/ma-v-lindsay-clancy-day-17 | 2026-08-21 | Digestor index — C3 Day 17 named chaplain-collateral voice backup (**Soften**; this fold; **day≠certified**; stamp **2026-08-21**; chaplain collateral ≠ Soften of capacity / guilt / CR / voices-as-certified-fact; charge colloquy ≠ Soften of law outcome) |
