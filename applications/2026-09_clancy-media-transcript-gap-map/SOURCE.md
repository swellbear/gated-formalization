...
**Role:** notes summary. Operator **ADMIT Soften S0** locks the board as poseable/citable — [`DIGESTION_S0.md`](DIGESTION_S0.md). Later same day: Soften C1 + Soften C3 + Soften C3 Day 14 + **Soften C3 Day 4** + **Digestor index expand** + **Digestor INTERIM mid-run** (**not** park). **NOT** Soften of the parent usefulness claim. **Success bar unset.** **NOT** Soften of any Day 4 line / Day 14 / Day 18 / digital timeline as certified fact. Hospital/scene/tox-preserve obs ≠ Soften of suicide / meds as fact. **LOUD media≠certified.** Day 1 missing / Days 22+ 404 = corpus **EDGE**. Softened set: **2, 3, 4, 7, 11, 14, 18**.  
...
**Digestor expanded corpus** = Days **2–21** + Closing Arguments **live**. Softened set = **2, 3, 4, 7, 11, 14, 18**. Standing GO = Lab invent/hand **Day 5** next, then remaining Digestor live days one at a time.
...
4. **C3 Day 4 ran.** ONE named Day 4 hospital/scene backup for Softened C1 G3 (primary) + G4 (light touch) + G6 honesty. See [`DIGESTION_C3_DAY4.md`](DIGESTION_C3_DAY4.md). **Day≠certified.** Closings still ≠ evidence. Hospital/scene/tox-preserve obs ≠ Soften of suicide / meds as fact.
5. **Index expand ran.** Operator **ADMIT Digestor index expand**. Days 2–21 + closings live. Day 2 typo slug named. Day 1 not found. Days 22+ 404. See [`REV_DAY_INDEX.md`](REV_DAY_INDEX.md) · [`DIGESTION_INDEX_EXPAND.md`](DIGESTION_INDEX_EXPAND.md). **LOUD media≠certified.** Index-live ≠ Soften.
6. **Standing GO** continues **named-day pulses** across the Digestor index. Softened set = **2, 3, 4, 7, 11, 14, 18**. Next = Lab invent/hand **Day 5**. Do **not** dump the index.
7. Similar unofficial media transcripts (non-Rev) stay the same **media / unofficial** class. They do **not** become certified record by substitution.
...
- **Day≠certified.** A named day page (Day 18 + Day 14 + Day 4 this string) is **not** the certified court-reporter record.
...
S0 is **Operator Soften** (poseable/citable). Later same day: Soften C1 + Soften C3 + Soften C3 Day 14 + Soften C3 Day 4 + Digestor index expand + Digestor INTERIM mid-run (**not** park). This is **not** usefulness Soften. **Success bar** stays unset. **Hold C2 / C4** only. Standing GO → Lab invent/hand **Day 5** next. Softened Day 2 / 3 / 7 / 11 **ADMITTED** (Day 2 + Day 7 + Day 11 on master as **#111** / **#109** / **#110**; Day 3 parallel — digest not yet on master; boards untouched).
