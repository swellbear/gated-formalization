...
**Closeout verdict:** Stable Provisional (split) — hard stop  
...
|---------|----------------------------------------|
| L1 OBJECT-FORECAST — package object is a **forecast** of most-likely outcomes; census is the evidence vehicle; commitment (incl. July 29) is not the object | Under package |
| L2 F-ML-BAR = P-BaseCase for GDP / U / PCE / core PCE; funds-rate dots **off** this bar | Evaluation freeze only; **bar not met** |
| L3 D-DOC — June 17 2026 SEP identity; 18 submitters (17 for 2028); March vintage 19 | Document text / process |
| L4 D-DEF — Q4/Q4; median/CT/range; funds midpoint; core-PCE-no-LR; RMSE/CPI footnotes | Reading conventions |
| L5 D-SEP — Table 1 medians/CT/range as *submitted* | Census of submissions; **not** F-ML met; **not** Committee forecast |
...
| L8 D-DOTS / D-HIST — Figure 2–3 distributions; dots = appropriate-path midpoints | Distributional census; **not** F-ML |
| L9 D-UNCERT — 17/18 PCE uncertainty higher and risks upside | Judgment tallies; ≠ RMSE fans |
| L10 D-RMSE — Table 2 / 70% fans **with** document caveats; CPI not PCE | Historical convention; ≠ current FOMC uncertainty |
| L11 C-APPROP = individual mandate reading | Meaning freeze; vote/realized-path **not met** |
| L12 F-LR = convergence under appropriate policy **and** no further shocks | Meaning freeze; dated/2026-on-target **not met** |
| L13 2026 F-ML-BAR **test executed** | Evaluation; bar **not established** for GDP 2.2 / U 4.3 / PCE 3.6 / core 3.3; **not** a refute |
...
| RMSE 70% fans = current FOMC uncertainty | **Blocked** (L16); document’s own split |
| 17/18 “higher” = a 70% interval | **Blocked** (L16) |
| CPI RMSE = PCE RMSE | **Blocked** (L4 + L16) |
| June 17 cells = 2026–28 realized outcomes | **Not in scope now** (Gap 8 open; L6 is 2021–25 only) |
| July 29 statement as in-package completion | **OUT** |
...
*(Brochure / freeze / median → clearance packages are Moderate+ vs original “most likely / appropriate / will converge” elevations. These terms could not be tested as unrestricted clearance from the SEP’s own tables.)*
...
| RMSE fan → current FOMC uncertainty | Over-strong metric swap | L16 |
| 17/18 → 70% interval | Over-strong | L16 |
| CPI RMSE → PCE | Over-strong metric swap | L4 + L16 |
| Amb drop / freeze → clearance | Over-strong | LOCK-003 |
| July 29 on residual menu → in-package | Package contamination | R-JULY29 **drop** |

### Strong language still unsupported
Unrestricted “these medians **are** the expected path”; “the Committee forecasts 3.6% PCE”; “appropriate policy **is** the vote”; “2026 is on the way to 2%”; “the 70% fans **are** current FOMC uncertainty.”

**Scoped vs unrestricted:** Scoped findings are **not** unrestricted support for the original forecast-extension package. Census of what was printed is established. Elevations are frozen and unmet.
...
**Required when strong language is mostly negatively constrained.**

Operator-facing choice (do not leave implicit):

- [ ] **Revise claim** — then run **Claim-Revision Scaffolding** before selecting/starting a successor (`run CR` / [R-REV](RESIDUAL_BRANCH_MENU.md#r-rev))  
- [x] **Keep original wording** — default at this closeout (CR **offered, not run**); research agenda / scoped dependents only
