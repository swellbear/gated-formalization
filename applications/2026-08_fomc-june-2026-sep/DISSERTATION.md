...
**Phase 2 classification:** **Not applicable.** Remaining work is later empirical (realization) or a new independent expected-path source, not theory generation. Mixed case: census done; unmet bars need evidence, not Experimental Generation.
...
| Item | Status |
|------|--------|
| **F-ML-BAR met** — 2026 GDP 2.2 / U 4.3 / PCE 3.6 / core 3.3 **are** the expected / central path | **Not established** — [R-FML-2026](RESIDUAL_BRANCH_MENU.md#r-fml-2026) executed; **not a refute** |
...
- SEP cell or the words “most likely” → P-BaseCase **met** (LOCK-010; L2 + L13).  
...
**Why “met” fails:** (1) Brochure circularity — the SEP posing figures as most-likely submissions is exactly what L2 said does not clear P-BaseCase; no independent matched expected-path admitted (rubric row 4: **No**). (2) Policy-mix — medians mix 18 different appropriate-policy conditionings (L11). (3) PCE/core extra — 17/18 upside risk vs “expected” if expected means mean; vintage jump. **Not a refute:** no rival expected-path admitted.
...
**Locked-bar status summary:** F-ML-BAR **frozen, not met** (2026 tested). C-APPROP as vote **not met**. F-LR as dated/2026-on-target **not met**. Census vehicle **established**.
...
- [R-FML-2026](RESIDUAL_BRANCH_MENU.md#r-fml-2026) — **executed**; not established. Re-open only via a new source class ([R-FML-INDEP](RESIDUAL_BRANCH_MENU.md#r-fml-indep)), not by re-reading Table 1.  
...
- [R-FML-INDEP](RESIDUAL_BRANCH_MENU.md#r-fml-indep) — park-until-trigger: operator-admitted non-SEP matched expected-path.  
- [R-FML-2027-28](RESIDUAL_BRANCH_MENU.md#r-fml-2027-28) — park-90d; diminishing returns after L13.  
...
- FD: pose/freeze/median → clearance; RMSE → current uncertainty; July 29 smuggle.  
- Portfolio / residual queue / claim-graph / pattern map / calibration updated this closeout.
