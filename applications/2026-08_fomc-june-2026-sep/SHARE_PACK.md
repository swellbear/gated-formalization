...
- Release identity: June 16–17, 2026 meeting; 18 submitters (one of those 18 skipped 2028); March vintage had 19  
- How to read the tables: Q4/Q4 GDP and PCE; Q4-average unemployment; funds-rate = year-end midpoint of an *appropriate* range; median / central tendency / range definitions; core PCE has no longer-run column  
- June **submitted** medians: 2026 GDP **2.2** / U **4.3** / PCE **3.6** / core PCE **3.3** / funds **3.8**; 2027–28 and longer-run cells as printed  
- March→June 2026 revisions as printed: PCE **+0.9**, funds **+0.4**, GDP **−0.2**  
- 17 of 18 said PCE uncertainty was **higher** than average and risks were to the **upside**  
- RMSE 70% fans exist **with** the document’s caveats (historical errors; CPI not PCE; may not match current judgments)  
- Meanings frozen: “most likely” = expected/central path **if** the bar is met; “appropriate” = individual mandate reading; longer run = convergence under appropriate policy **and** no further shocks  
- Load-bearing census statistic = **median of 18** (17 for 2028); years are separate slots; uncertainty tallies ≠ RMSE fans
...
- RMSE fans = current FOMC uncertainty; 17/18 = a 70% interval; CPI RMSE = PCE  
- 2026–28 actuals matching the medians (not in scope now)  
- Anything from the July 29 statement
...
**Offered — not run.** See §5 / [`OPTIONAL_MODES_MENU.md`](OPTIONAL_MODES_MENU.md#ux).
...
- Residuals: [`RESIDUAL_BRANCH_MENU.md`](RESIDUAL_BRANCH_MENU.md)  
