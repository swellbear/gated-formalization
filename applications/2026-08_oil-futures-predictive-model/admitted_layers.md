...
**Meaning lock:** Rank 4 nested split — `Lock_Rank4_Nested_Split.md`. **V-COST-V2**. **L-SCREEN-Y-PROMOTE**. **L-HUNT-CL-SEAS**. **L-HUNT-CL-INV**. **L-HUNT-SPOT-TREND**. **L-HUNT-SPOT-INV**. **L-HUNT-SPOT-CROSS**. **L-HUNT-SPOT-LOGIT**. **L-HUNT-COT**. **L-HUNT-DJT**. **L-HUNT-PRETELL**. **L-HUNT-GAP**. V-SRC **leave unnamed**. **F-SRC-CME-TAPE** (named). **H-LAG-WF** named and scored (does not promote). **H-SPARSE-CAL** / **H-SPARSE-VOL** named and scored (neither promotes). **H-GAP-FADE** / **H-GAP-CONT** named and scored (FADE small F-DAY; does not promote). **H-DJT-WEEK** / **H-DJT-MONTH** named and scored (no discovery survivor). **H-COT-NET** / **H-COT-CHG** named and scored (no discovery survivor). **H-SPOT-FLIP-HOLD** / **H-SPOT-REV** named and scored (no discovery survivor either board). **H-SPOT-INV-CONT** / **H-SPOT-INV-FADE** named and scored (no discovery survivor either board). **H-SPOT-CROSS-B2W** / **H-SPOT-CROSS-W2B** named and scored (WTI B2W burned; Brent W2B discovery survivor; confirm tiny 250 ≠ met). **H-SPOT-LOGIT-FULL** / **H-SPOT-LOGIT-SIGN** named and scored (discovery beat both boards; FULL confirm lose all windows both boards). **H-CL-INV-SURP** / **H-CL-INV-WOW** named and scored (discovery both lose; no survivor; do not pick least-bad WOW). **H-CL-SEAS-ANN** / **H-CL-SEAS-MON** named and scored (discovery both lose; no survivor; do not pick least-bad ANN). **L-SESS**.
...
- `04_Material_Admission_Proven_Class_Search.md` (**L-HUNT-PROVEN**) — proven-only hunt; **no class submitted**; F-SKILL **not established**.
- `04_Material_Admission_V_VALUE_No_Recipe.md` (**V-VALUE-TEST-0**) — V-VALUE **not established**.
- `Lock_VSRC_Leave_Unnamed.md` — V-SRC sealed unnamed; not a refute of all books.
...
- `04_Material_Admission_Spot_Logit.md` (**L-HUNT-SPOT-LOGIT** + **L-PULSE-SPOT-LOGIT-1**) — expanding logistic; discovery beat both boards (**H-SPOT-LOGIT-FULL** survivor, SIGN tie); confirm **lose** all windows both boards; named Track B queue **empty**; spot-trend **not established**.
- `04_Material_Admission_CL_Inv.md` (**L-HUNT-CL-INV** / **L-STANDIN-EIA-INV-CL** + **L-PULSE-CL-INV-1**) — two EIA weekly inventory overlay horses on Yahoo CL; discovery F-CC **both lose** (0 = 0.026705; closest WOW 0.026803); **no survivor**; confirm skipped; do **not** pick least-bad; skill **not established**.
- `04_Material_Admission_CL_Seas.md` (**L-HUNT-CL-SEAS** + **L-PULSE-CL-SEAS-1**) — two annual-season overlay horses on Yahoo CL; discovery F-CC **both lose** (0 = 0.026705; closest ANN 0.026799); **no survivor**; confirm skipped; do **not** pick least-bad; skill **not established**.

**Closeout (2026-08-17; pulse 2026-09-01):** **hard stop (residuals live)**. Skill leftover [R-F-SKILL](RESIDUAL_BRANCH_MENU.md#r-f-skill) **pursue** (CL-SEAS no survivor; next frozen **C-CL-DOW**). [R-SPOT-TREND](RESIDUAL_BRANCH_MENU.md#r-spot-trend) executed (LOGIT confirm lose; queue empty; **not established**).

**Process imports:** LOCK-003, LOCK-009, LOCK-010, LOCK-011. App-local: **V-COST-V2**; V-SRC leave unnamed; **F-SRC-CME-TAPE**; **L-STANDIN-Y-CLF**; **L-SCREEN-Y-PROMOTE**; **L-HUNT-CL-SEAS**; **L-HUNT-CL-INV**; **L-HUNT-SPOT-TREND**; **L-HUNT-SPOT-INV**; **L-HUNT-SPOT-CROSS**; **L-HUNT-SPOT-LOGIT**; **L-HUNT-COT**; **L-HUNT-DJT**; **L-HUNT-PRETELL**; **L-HUNT-GAP**; **H-SPARSE-CAL**; **H-SPARSE-VOL**; D-EXIST-MET-FT (2026-08-17).
