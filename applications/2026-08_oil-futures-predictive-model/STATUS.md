...
**Residuals:** [R-F-SKILL](RESIDUAL_BRANCH_MENU.md#r-f-skill) **pursue** (H-LAG scored, lost on F-CC; later named Yahoo classes burned; **queue empty**; H-KS not run) · Track B burned-class invent queue **empty**; live scoped horse Brent **H-SPOT-MOY-CONT** (**FRAGILE**; Lab batch 3 scoped confirm + batch 4 ROBUST + Deep1 P1/P2 Amb constraints; **not** skill-met; **not** elevated; **not** a null-burn; **not** C-SPOT-SEAS established; **not** WTI-met; separate object; not F-SKILL; P3=B held — see #32) · [R-LIVE-STANDIN](RESIDUAL_BRANCH_MENU.md#r-live-standin) **executed** · [R-F-COMBO](RESIDUAL_BRANCH_MENU.md#r-f-combo) park-until-trigger · [R-V-VALUE](RESIDUAL_BRANCH_MENU.md#r-v-value) park-until-trigger (**V2 named**; book unnamed)
