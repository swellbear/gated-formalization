...
| **Phase** | Named-horses pulse **L-PULSE-HORSES-1** (executed; bars not met) + later named Yahoo / Track B hunts **recorded as null** (scripts not on master) + Track B Lab batch 1 + batch 2 **REJECT / burn** + batch 3 burns + Brent MOY-CONT **scoped confirm pass** (not skill-met) |
| **Amb** | **1.0** (**≠ clearance**) |
