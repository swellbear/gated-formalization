...
- [ ] Residual-branch menu (`RESIDUAL_BRANCH_MENU.md`) if residuals remain — offering ≠ running
- [ ] **Optional-modes menu** (`OPTIONAL_MODES_MENU.md`) — offering ≠ running (**required at endpoint/hard stop**)
