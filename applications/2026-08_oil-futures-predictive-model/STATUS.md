...
| **Phase** | Named-horses pulse **L-PULSE-HORSES-1** (executed; bars not met) + later named Yahoo / Track B hunts **recorded as null** (scripts not on master) + Track B Lab batch 1 + batch 2 **REJECT / burn** + batch 3 burns + batch 4 burns SHRINK/VOLTGT/QUANT + Brent MOY-CONT **scoped confirm pass, FRAGILE** (not skill-met; not elevated) |
| **Amb** | **1.0** (**≠ clearance**) |
