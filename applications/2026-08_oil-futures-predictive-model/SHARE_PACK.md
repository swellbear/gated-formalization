...
Walk-forward skill versus last settlement is **not shown**. Yahoo `CL=F` is a **stipulated stand-in**. A named Trump Truth Social week/month oil-sentiment hunt **failed at discovery** (both **tied** no-change). Overnight-gap **fade** had a **small day-session** edge; the whole trip was unchanged — **does not promote**. A named eight-horse pretell hunt **failed at discovery**. Two sparse horses were scored. **Neither promotes.** Overnight-only edges do not promote. Kearney–Shang was **not run**.
...
- Next-session CL log-return skill vs last settlement (**L-HUNT-DJT** no survivor; **H-GAP-FADE** small F-DAY / F-CC **tie**; **L-HUNT-PRETELL** no survivor; **H-SPARSE-CAL** tiny 500 / **fails** 750; **H-SPARSE-VOL** and **H-LAG-WF** F-CC **loss**; leftover **live**)  
...
| Amb | **1.0** |
| Locks / layers | Rank 4; D-EXIST-MET-FT; **V-COST-V2**; **L-SCREEN-Y-PROMOTE**; **L-HUNT-DJT**; **L-HUNT-GAP**; **L-HUNT-PRETELL**; F-SRC-CME-TAPE; L-STANDIN-Y-CLF; **H-LAG-WF**; **H-SPARSE-CAL**; **H-SPARSE-VOL**; L-SESS; V-SRC leave unnamed |
