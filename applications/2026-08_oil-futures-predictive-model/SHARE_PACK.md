...
Walk-forward skill versus last settlement is **not shown**. Yahoo `CL=F` is a **stipulated stand-in**. A named eight-horse pretell hunt **failed at discovery** (no survivor; confirm skipped). Two sparse horses were scored. **Neither promotes.** The calendar horse’s last-500 whole-trip dip is tiny and **loses** on last 750. Overnight-only edges do not promote. Kearney–Shang was **not run**.
...
- Next-session CL log-return skill vs last settlement (**L-HUNT-PRETELL** no survivor; **H-SPARSE-CAL** tiny 500 / **fails** 750; **H-SPARSE-VOL** and **H-LAG-WF** F-CC **loss**; leftover **live**)  
...
| Amb | **1.0** |
| Locks / layers | Rank 4; D-EXIST-MET-FT; **V-COST-V2**; **L-SCREEN-Y-PROMOTE**; **L-HUNT-PRETELL**; F-SRC-CME-TAPE; L-STANDIN-Y-CLF; **H-LAG-WF**; **H-SPARSE-CAL**; **H-SPARSE-VOL**; L-SESS; V-SRC leave unnamed |
