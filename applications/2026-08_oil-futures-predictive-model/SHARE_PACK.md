...
Walk-forward skill versus last settlement is **not shown**. Yahoo `CL=F` is a **stipulated stand-in**. Two sparse horses (calendar-day OLS; big-prior-move OLS) were scored. **Neither promotes.** The calendar horse’s last-500 whole-trip dip is tiny and **loses** on last 750. Overnight-only edges do not promote. Kearney–Shang was **not run**.
...
| Amb | **1.0** |
| Locks / layers | Rank 4; D-EXIST-MET-FT; **V-COST-V2**; **L-SCREEN-Y-PROMOTE**; F-SRC-CME-TAPE; L-STANDIN-Y-CLF; **H-LAG-WF**; **H-SPARSE-CAL**; **H-SPARSE-VOL**; L-SESS; V-SRC leave unnamed |
