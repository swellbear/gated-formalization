...
Lean Default Path: `leave skill not shown`, a **different** named CL horse on Yahoo (do **not** pick least-bad WOW), or `name` a **new** spot class (queue empty). Do **not** auto-open live CME. Do **not** unburn burned spot rows. Do **not** retune FULL. Existence stays separate. Do not enter Phase 2.
