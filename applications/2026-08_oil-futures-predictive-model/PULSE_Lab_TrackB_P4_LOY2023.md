...
- **Founder addendum:** after P4 HARDEN, **Track B invent is paused** (digest). Lab held unless Founder/user locks a new named-gap solve string.
...
- After P4 HARDEN, **Track B invent is paused** (digest). Do **not** mint a new invent string unless Founder/user locks a new named-gap solve string.

---

*Docs only. Track B ≠ F-SKILL. Amb HARDEN ≠ skill-met. FRAGILE ≠ elevated. Not a null burn. Not RESTATE. Invent paused (digest). Not trading advice.*
