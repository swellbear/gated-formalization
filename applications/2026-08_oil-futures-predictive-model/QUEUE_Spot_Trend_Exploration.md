...
**Status:** **C-SPOT-INV** is the active pulse. Confirm still unseen at lock time for INV.
...
**Burned (do not retune / do not unburn):** H-SPOT-FLIP-HOLD and H-SPOT-REV on **WTI** and on **Brent**.
...
**Already run:** **C-SPOT-INV** (this pulse).
