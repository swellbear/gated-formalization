...
**Method path:** Phase 1 only. … → **L-HUNT-SPOT-TREND**; pulse **L-PULSE-SPOT-1** (no survivor) → **L-HUNT-SPOT-INV**; pulse **L-PULSE-SPOT-INV-1** (no survivor either board) → **L-HUNT-SPOT-CROSS**; pulse **L-PULSE-SPOT-CROSS-1** (WTI fail; Brent confirm tiny 250) → **L-HUNT-SPOT-LOGIT**; pulse **L-PULSE-SPOT-LOGIT-1** (discovery beat both boards; confirm lose all windows; queue empty; F-SKILL parked). No Phase 2.
...
Stand-in baseline, **H-LAG-WF**, **H-SPARSE-CAL**, **H-SPARSE-VOL**, **L-HUNT-PRETELL**, **H-GAP-FADE** / **H-GAP-CONT**, **L-HUNT-DJT**, **L-HUNT-COT**, **L-HUNT-SPOT-TREND**, **L-HUNT-SPOT-INV**, **L-HUNT-SPOT-CROSS**, **L-HUNT-SPOT-LOGIT** — **not** bar-met. Paper costs **V2**. No named book, so V-VALUE still unused.
