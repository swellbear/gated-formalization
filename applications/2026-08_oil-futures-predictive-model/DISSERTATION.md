...
Walk-forward skill on next-session CL log-returns versus last settlement is **not shown**. Yahoo `CL=F` is a **stipulated stand-in**. The next unused CL recipe — a two-horse annual season overlay (**L-HUNT-CL-SEAS**) — **failed at discovery** (Fourier and month dummies both **lost** to no-change; closest was Fourier; do **not** pick least-bad; confirm skipped). Frozen next class is weekday overlay. A two-horse EIA weekly inventory overlay (**L-HUNT-CL-INV**) also **failed at discovery** (SURP and WOW both **lost**; closest was WOW; do **not** pick least-bad; confirm skipped). A named two-horse cash WTI/Brent 21-day hunt (**L-HUNT-SPOT-TREND**) **failed at discovery** (both rules **lost** to continuation on both oils; confirm skipped). A WTI↔Brent cross-bench overlay (**L-HUNT-SPOT-CROSS**) **failed to establish** spot-trend (WTI B2W **lost** discovery; Brent W2B confirm beat but last-250 **tiny +1**). An expanding-window logistic drawer (**L-HUNT-SPOT-LOGIT**) **beat continuation on discovery** both boards, then **lost confirm** on every locked window both boards — Discovery ≠ confirm clearance; named Track B queue **empty**. A named two-horse CFTC managed-money hunt (**L-HUNT-COT**) **failed at discovery** (both net and week-change **lost** vs no-change). A named two-horse Trump Truth Social hunt (**L-HUNT-DJT**) **failed at discovery** (both week/month averages **tied** no-change; daily scores on older oil-session dates were all zero). Overnight-gap **fade** (**H-GAP-FADE**) had a **small F-DAY** confirm edge; F-CC was locked to no-change — it **does not promote**. Continuation **lost** discovery F-DAY. A named eight-horse pretell hunt (**L-HUNT-PRETELL**) **failed at discovery**. Two sparse horses (**H-SPARSE-CAL**, **H-SPARSE-VOL**) were scored. The calendar horse’s last-500 F-CC dip is **0.000004** and **loses** on last 750 — it **does not promote**. The vol-state horse **lost** on F-CC. A lagged-return horse (**H-LAG-WF**) also **lost** on F-CC. Kearney–Shang **not run**.
...
**Method path:** Phase 1 only. … → **L-HUNT-SPOT-TREND**; pulse **L-PULSE-SPOT-1** (no survivor) → **L-HUNT-SPOT-INV**; pulse **L-PULSE-SPOT-INV-1** (no survivor either board) → **L-HUNT-SPOT-CROSS**; pulse **L-PULSE-SPOT-CROSS-1** (WTI fail; Brent confirm tiny 250) → **L-HUNT-SPOT-LOGIT**; pulse **L-PULSE-SPOT-LOGIT-1** (discovery beat both boards; confirm lose all windows; queue empty) → **L-HUNT-CL-INV**; pulse **L-PULSE-CL-INV-1** (discovery both lose; no survivor; confirm skipped; do not pick least-bad WOW) → **L-HUNT-CL-SEAS**; pulse **L-PULSE-CL-SEAS-1** (discovery both lose; no survivor; confirm skipped; do not pick least-bad ANN; F-SKILL not established). No Phase 2.
...
| Item | Status |
|------|--------|
| F-SKILL: real shot of beating last-settlement RMSE, walk-forward, next-session CL log-return | **not established** (CL-INV no survivor; COT no survivor; DJT no survivor; FADE small F-DAY / F-CC tie; pretell no survivor; CAL tiny 500 / fails 750; VOL and H-LAG lost on F-CC; H-KS not run; stand-in; not a refute) — **live residual** |
| Spot 21-day sign vs continuation (Track B) | **not established** (**L-PULSE-SPOT-1** / **INV-1** no survivor; **CROSS-1** WTI fail / Brent confirm tiny 250 ≠ met; **LOGIT-1** discovery beat / confirm lose; queue empty; not a refute of every trend rule) |
...
Stand-in baseline, **H-LAG-WF**, **H-SPARSE-CAL**, **H-SPARSE-VOL**, **L-HUNT-PRETELL**, **H-GAP-FADE** / **H-GAP-CONT**, **L-HUNT-DJT**, **L-HUNT-COT**, **L-HUNT-CL-INV**, **L-HUNT-CL-SEAS**, **L-HUNT-SPOT-TREND**, **L-HUNT-SPOT-INV**, **L-HUNT-SPOT-CROSS**, **L-HUNT-SPOT-LOGIT** — **not** bar-met. Paper costs **V2**. No named book, so V-VALUE still unused.
...
Promote gate: **none fire**. **L-HUNT-CL-SEAS** discovery F-CC last 500 of prefix ≤ 2023-08-21: RMSE 0 = **0.026705**; **H-CL-SEAS-ANN** **0.026799** (beats_0 false, closest); **H-CL-SEAS-MON** **0.026816** (beats_0 false); **no survivor**; confirm skipped; do **not** pick least-bad. **L-HUNT-CL-INV** discovery F-CC last 500 of prefix ≤ 2023-08-21: RMSE 0 = **0.026705**; **H-CL-INV-SURP** **0.026836** (beats_0 false); **H-CL-INV-WOW** **0.026803** (beats_0 false, closest); **no survivor**; confirm skipped; do **not** pick least-bad. **L-HUNT-SPOT-LOGIT** discovery: WTI FULL/SIGN **0.532** (266) vs cont **0.508** (254); Brent FULL/SIGN **0.550** (275) vs cont **0.506** (253) — survivor **H-SPOT-LOGIT-FULL** (tie) both boards. Confirm FULL — **ALL LOSE**: WTI 500 **0.430** vs **0.552**; 250 **0.476** vs **0.572**; 750 **0.463** vs **0.557**; Brent 500 **0.442** vs **0.522**; 250 **0.496** vs **0.524**; 750 **0.465** vs **0.525**. Spot-trend **not established**. Named queue **empty**. **L-HUNT-SPOT-CROSS** discovery: WTI B2W **0.494** (247) vs cont **0.508** (254) — **no survivor**, burned; Brent W2B **0.528** (264) vs cont **0.506** (253) — survivor. Confirm Brent W2B: last 500 **0.544** (272) vs **0.522** (261); last 250 **0.528** (132) vs **0.524** (131) — **tiny +1**; last 750 **0.545** (409) vs **0.525** (394). **L-HUNT-SPOT-INV** discovery: both lose continuation (WTI CONT 0.506 vs 0.508; Brent CONT 0.502 vs 0.506); **no survivor**. **L-HUNT-SPOT-TREND** discovery: both horses lose continuation on WTI (0.508 vs 0.494 / 0.492) and Brent (0.506 vs 0.496 / 0.494); **no survivor**; confirm skipped (wrong object for Yahoo promote). **L-HUNT-COT** discovery F-CC: both lose vs 0 = 0.026705 (closest H-COT-NET 0.026796); **no survivor**. **L-HUNT-DJT** discovery F-CC: both horses **tie** 0 = 0.026705; session-day scores all zero; **no survivor**. **H-GAP-FADE** confirm last-500 F-DAY 0.026584 vs 0 0.026634 (small); F-CC **tie**. **L-HUNT-PRETELL** discovery F-CC: all eight lose vs 0 = 0.026705; **no survivor**. H-KS-FTS **not run**. Tiny ≠ met. Day win ≠ promote. Equal-to-0 ≠ beat-0. Confirm ≠ train. Discovery ≠ confirm clearance. No survivor ≠ least-bad. WTI-met ≠ Brent-met.
...
**Locked-bar status summary:** D-EXIST **established** (futures-target only). F-SKILL **not established** (CL-INV no survivor; COT no survivor; DJT no survivor; FADE small F-DAY / F-CC tie; pretell hunt no survivor; CAL tiny 500 / fails 750; VOL and H-LAG lost on F-CC; H-KS not run). V-VALUE **not established**.

**Continuation / hard-stop note:** Hygiene sealed. Optional modes declined. Skill leftover stays **live** ([R-F-SKILL](RESIDUAL_BRANCH_MENU.md#r-f-skill); CL-INV no survivor; do not pick least-bad WOW). Spot-trend drawer **executed** ([R-SPOT-TREND](RESIDUAL_BRANCH_MENU.md#r-spot-trend); LOGIT confirm lose; queue empty; not established). Tape leftover **executed** as stand-in ([R-LIVE-STANDIN](RESIDUAL_BRANCH_MENU.md#r-live-standin)); reopen live **only if** **L-SCREEN-Y-PROMOTE** fires. Phase 2 not entered. Next: `leave skill not shown` · `name horse …` (**different** CL recipe on Yahoo) · name a **new** spot class · `leave screen rule`. **Do not** auto-open DataMine.
...
| L-PULSE-SPOT-1 | **1.0** | Unchanged; FLIP/REV lose continuation both boards; no survivor |
| L-PULSE-SPOT-INV-1 | **1.0** | Unchanged; INV-CONT/FADE lose both boards; no survivor |
| L-PULSE-SPOT-CROSS-1 | **1.0** | Unchanged; WTI B2W burned; Brent W2B confirm tiny 250 ≠ met |
| L-PULSE-SPOT-LOGIT-1 | **1.0** | Unchanged; FULL discovery beat / confirm lose both boards; queue empty |
| L-PULSE-CL-INV-1 | **1.0** | Unchanged; SURP/WOW discovery both lose; no survivor; do not pick least-bad WOW |
...
| L-HUNT-SPOT-CROSS | Named WTI↔Brent 21-day cross-bench; WTI B2W burned; Brent W2B confirm tiny 250 | `Lock_Hunt_Spot_Cross.md` |
| L-PULSE-SPOT-CROSS-1 | Cross-bench pulse; spot-trend not established | `04_Material_Admission_Spot_Cross.md` |
| L-HUNT-SPOT-LOGIT | Named expanding logistic; discovery beat; confirm lose; queue empty | `Lock_Hunt_Spot_Logit.md` |
| L-PULSE-SPOT-LOGIT-1 | Logistic pulse; spot-trend not established | `04_Material_Admission_Spot_Logit.md` |
| L-HUNT-CL-INV / L-STANDIN-EIA-INV-CL | Named EIA weekly inventory overlay on Yahoo CL; no discovery survivor | `Lock_Hunt_CL_Inv.md` |
| L-PULSE-CL-INV-1 | CL inventory pulse; skill not established; do not pick least-bad | `04_Material_Admission_CL_Inv.md` |
| L-HUNT-CL-SEAS | Named annual season overlay on Yahoo CL; no discovery survivor | `Lock_Hunt_CL_Seas.md` |
| L-PULSE-CL-SEAS-1 | CL season pulse; skill not established; do not pick least-bad | `04_Material_Admission_CL_Seas.md` |

### Key artifacts

- `DISSERTATION.md` · `SHARE_PACK.md` · `EXECUTIVE_BRIEF.md` · `05_Original_Claim_Assessment_Closeout.md` · `final_verdict.md` · `RESIDUAL_BRANCH_MENU.md` · `OPTIONAL_MODES_MENU.md` · `MAP_Futures_Target_Forecasting_Methods.md` · `MAP_What_Can_Move_CL.md` · `Lock_Session_Split.md` · `MAP_Session_Split.md` · `Lock_FSRC_Named_CME_Tape.md` · `PULSE_Baseline_Session_RMSE.md` · `Lock_VCOST_V2.md` · `Lock_Screen_Yahoo_Promote.md` · `Lock_Horses_Sparse.md` · `PULSE_Horses_Sparse.md` · `Lock_Hunt_Pretell.md` · `PULSE_Hunt_Pretell.md` · `Lock_Horses_Gap.md` · `PULSE_Horses_Gap.md` · `Lock_Hunt_DJT.md` · `PULSE_Hunt_DJT.md` · `Lock_Hunt_COT.md` · `PULSE_Hunt_COT.md` · `Lock_Hunt_Spot_Logit.md` · `PULSE_Hunt_Spot_Logit.md` · `Lock_Hunt_CL_Inv.md` · `PULSE_Hunt_CL_Inv.md` · `Lock_Hunt_CL_Seas.md` · `PULSE_Hunt_CL_Seas.md`
