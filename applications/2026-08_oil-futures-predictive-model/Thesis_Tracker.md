...
- Track B spot-trend skill **not established** (Lab batch 1 + batch 2 **REJECT / burn**; batch 3 burns VIX/THRESH/SKEW plus SEAS MOY-DIR / WTI MOY-CONT; batch 4 burns SHRINK/VOLTGT/QUANT — confirm-none among new skill horses). Brent **H-SPOT-MOY-CONT** remains a **scoped confirm pass** now **FRAGILE** — **not** a null, **not** skill-met, **not** elevated, **not** C-SPOT-SEAS established, **not** WTI-met. Year-stability Amb constrained **toward fragile**, not clearance. Deep1 **P1/P2 ADMIT as Amb constraint only** (cutoff/vehicle): FRED confirm among {2018,2020,2023} is not a single-cutoff artifact (2015 disc KILL); EIA last-750 flips; 2023 LOY fail is not FRED-only. **P4 C-SPOT-LOY2023-DECOMP ADMIT HARDEN as Amb constraint only**: FRED 2023-08-22..2023-12-31 n=91 agg/halves FAIL; 3/4 months not-strict-beat (Oct blow-up; Nov/Dec ties; Sep beats); EIA same HARDEN pattern. HARDEN toward “2023 really broke year-stability” (not thin-stub-only / not single-month-only). Still **not** skill-met / **not** elevate / **not** null-burn. **P3=B** parks all-day directional invent; residual live = vehicle/cutoff fragility on that Brent horse (year-stability slice HARDENED). Lab one-probe allotment **DONE**. **Founder addendum:** after P4 HARDEN, **Track B invent is paused** (digest). Lab held unless Founder/user locks a new named-gap solve string. Digestion written ([`DIGESTION_TrackB_2026-09-05.md`](DIGESTION_TrackB_2026-09-05.md)); invent paused. **NOT RESTATE**. Separate from F-SKILL.
...
**Keep saying:** A specified non-no-change futures-target recipe has been written. Yahoo is a **stand-in**; the baseline is **not** a pass. The named Yahoo CL queue is **empty**; skill leftover is still **live**. Track B Lab batch 1 + batch 2 are **REJECT / burn** (confirm-none). Batch 3 burns VIX/THRESH/SKEW; batch 4 burns SHRINK/VOLTGT/QUANT. Brent **H-SPOT-MOY-CONT** is a scoped confirm pass now **FRAGILE**, **not** skill-met, **not** elevated, and **not** a null. Deep1 P1/P2 tighten cutoff/vehicle Amb only — still not skill-met. P4 HARDEN tightens year-stability Amb toward “2023 really broke year-stability” (Oct blow-up; late ties; not thin-stub-only) — still not skill-met. All-day Track B directional hunt is **parked** (P3=B); leftover is vehicle/cutoff fragility on that horse. Lab one-probe allotment is **DONE**. After P4 HARDEN, **Track B invent is paused** (digest) unless Founder/user locks a new named-gap solve string. Digestion written; invent paused. Spot-trend skill is **not established**. Paper costs are **V2**; that is not a value pass. Skill and after-cost value are not established.
...
- `PULSE_Lab_TrackB_Batch4.md`
- `PULSE_Lab_TrackB_Deep1_P1P2.md`
- `PULSE_Lab_TrackB_P4_LOY2023.md`
- `DIGESTION_TrackB_2026-09-05.md`
