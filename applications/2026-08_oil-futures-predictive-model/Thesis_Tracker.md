...
**Status:** **Stable Provisional (split) — hard stop (residuals live)** · Phase 1 closeout · D-EXIST-MET-FT · **F-SRC-CME-TAPE** · **L-SCREEN-Y-PROMOTE** · **L-HUNT-CL-SEAS** · **L-HUNT-CL-INV** · **L-HUNT-SPOT-TREND** · **L-HUNT-SPOT-INV** · **L-HUNT-SPOT-CROSS** · **L-HUNT-SPOT-LOGIT** · **L-HUNT-COT** · **L-HUNT-DJT** · **L-HUNT-GAP** · **L-HUNT-PRETELL** · L-SESS  
...
**Successor / Rank lock (if any):** **Rank 4** nested split — D-EXIST ⊂ F-SKILL ⊂ V-VALUE. **D-EXIST-MET-FT**. V-COST **V2**. **F-SRC-CME-TAPE**. **L-SCREEN-Y-PROMOTE**. **L-HUNT-CL-SEAS**. **L-HUNT-CL-INV**. **L-HUNT-SPOT-TREND**. **L-HUNT-SPOT-INV**. **L-HUNT-SPOT-CROSS**. **L-HUNT-SPOT-LOGIT**. **L-HUNT-COT**. **L-HUNT-DJT**. **L-HUNT-GAP**. **L-HUNT-PRETELL**. V-SRC leave unnamed. CR **declined**, not run; default keep original wording.
...
- **L-SCREEN-Y-PROMOTE** — Yahoo screen; live CME only if F-CC beats 0 on last 500 and does not lose on 250/750; H-CL-SEAS / H-CL-INV / H-SPOT / H-COT / H-DJT / H-GAP-FADE / pretell hunt / H-LAG / CAL / VOL do not promote.
...
- F-SKILL **not established** (**L-HUNT-CL-SEAS** no survivor — do not pick least-bad ANN; **L-HUNT-CL-INV** no survivor — do not pick least-bad WOW; L-HUNT-SPOT-TREND is a different object and also no survivor; L-HUNT-COT no survivor; L-HUNT-DJT no survivor; H-GAP-FADE small F-DAY / F-CC tie; L-HUNT-PRETELL no survivor; H-SPARSE-CAL tiny 500 / fails 750; H-SPARSE-VOL and H-LAG-WF lost on F-CC; H-KS not run; not a refute of all recipes).
- Spot 21-day skill vs continuation **not established** (**L-PULSE-SPOT-1** / **INV-1** no survivor; **CROSS-1** WTI fail / Brent confirm tiny 250 ≠ met; **LOGIT-1** discovery beat / confirm **lose** all windows both boards; named queue **empty**).
...
| [R-F-SKILL](RESIDUAL_BRANCH_MENU.md#r-f-skill) | Named class for F-SKILL (F-CC + F-ON/F-DAY exhibits) | **L-HUNT-CL-SEAS** no survivor (do not pick least-bad ANN). **L-HUNT-CL-INV** no survivor (do not pick least-bad WOW). **L-HUNT-COT** no survivor. **L-HUNT-DJT** no survivor. **H-GAP-FADE** small F-DAY / F-CC **tie**. **L-HUNT-PRETELL** no survivor. **H-SPARSE-CAL** tiny 500 / **fails** 750. **H-SPARSE-VOL** / **H-LAG-WF** F-CC **loss**. H-KS not run. **not established**. `pursue`. Reopen: frozen **C-CL-DOW** |
| [R-SPOT-TREND](RESIDUAL_BRANCH_MENU.md#r-spot-trend) | Cash WTI/Brent 21-day sign vs continuation | **Executed → not established** (INV no survivor; CROSS WTI fail / Brent tiny 250; LOGIT discovery beat / confirm lose; queue empty). Reopen: `leave` · Yahoo horse · name **new** spot class (do not retune FULL; do not unburn; do not change 21) |
...
**Keep saying:** A specified non-no-change futures-target recipe has been written. Yahoo is a **stand-in**; the baseline is **not** a pass. Screen on Yahoo; live CME only if the whole-trip gate fires. The annual-season overlay **failed at discovery** — do **not** pick least-bad ANN. Paper costs are **V2**; that is not a value pass. Skill leftover still **pursue**. Frozen next class is **C-CL-DOW**. Skill and after-cost value are not established. Not a trade.

**Test next (only if authorized):** chip frozen **C-CL-DOW** · `leave skill not shown` · name a **new** spot class (Track B queue **empty**). Live CME only if the F-CC promotion gate fires. Do **not** unburn. Do **not** pick least-bad ANN. Do **not** retune FULL. Do **not** change 21.
...
- `Lock_Horses_Sparse.md`
- `PULSE_Horses_Sparse.md`
- `04_Material_Admission_Sparse.md`
- `02_Gate_Scoring_After_Sparse.md`
- `Lock_Hunt_Pretell.md`
- `PULSE_Hunt_Pretell.md`
- `04_Material_Admission_Pretell.md`
- `02_Gate_Scoring_After_Pretell.md`
- `Lock_Horses_Gap.md`
- `PULSE_Horses_Gap.md`
- `04_Material_Admission_Gap.md`
- `02_Gate_Scoring_After_Gap.md`
- `Lock_Hunt_DJT.md`
- `PULSE_Hunt_DJT.md`
- `04_Material_Admission_DJT.md`
- `02_Gate_Scoring_After_DJT.md`
- `data/sparse_calendar.json`
- `data/horse_scores.json`
- `data/pretell_hunt_scores.json`
- `data/gap_horse_scores.json`
...
- `Lock_Hunt_Spot_Cross.md`
- `PULSE_Hunt_Spot_Cross.md`
- `Lock_Hunt_Spot_Logit.md`
- `PULSE_Hunt_Spot_Logit.md`
- `Lock_Hunt_CL_Inv.md`
- `PULSE_Hunt_CL_Inv.md`
- `04_Material_Admission_CL_Inv.md`
...
- Parent / successor: —
- Key admissions / locks: Rank 4; **D-EXIST-MET-FT**; **V-COST-V2**; **F-SRC-CME-TAPE**; **L-STANDIN-Y-CLF**; **L-SCREEN-Y-PROMOTE**; **L-HUNT-CL-SEAS**; **L-HUNT-CL-INV**; **L-HUNT-SPOT-LOGIT**; **L-HUNT-SPOT-CROSS**; **L-HUNT-COT**; **L-HUNT-DJT**; **L-HUNT-GAP**; **L-HUNT-PRETELL**; V-SRC leave unnamed; L-PULSE-STANDIN-1 (baseline not met); F-SKILL/V-VALUE not established; spot-trend not established (queue empty)
