...
| [R-F-SKILL](#r-f-skill) | Next-session CL log-return skill vs last settlement (F-CC), plus F-ON/F-DAY exhibits? | Empirically resolvable | **H-GAP-FADE** small F-DAY (no promote); **L-HUNT-PRETELL** no survivor; **H-SPARSE-CAL** / **H-SPARSE-VOL** / **H-LAG-WF** scored (all fail promote); **H-KS-FTS** not run | **pursue** (**not established**) |
...
**Authorize grammar:** `leave skill not shown` · `name horse …` (different; do **not** remix gap horses; do **not** re-hunt confirm) · `leave screen rule` · `authorize branch R-…` · `decline residual menu`
...
| **Disposition** | **pursue** (FADE small F-DAY, no promote; hunt failed at discovery; CAL/VOL/H-LAG fail promote; next horse must be **different**; **not established**) |
