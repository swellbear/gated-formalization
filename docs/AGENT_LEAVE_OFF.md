...
| Field | Value |
|-------|--------|
| Updated | 2026-09-08 17:00 EDT (CoS assigned operator RUN-ONLY on PROPOSED 02 `R-SKIP-2TO1-FAVORITE`. Bar still not binding. HOLD stands.) |
