...
| Status | assigned |
| Handoff | I_farm_open assigned. Unused clock slots empty. Invent next kind or write farm_menu_exhausted. Hour-close still executing. Consult off. HOLD stands. Trading NOT ARMED. next=lab |
