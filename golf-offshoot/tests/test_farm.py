...
def test_farm_module_does_not_import_honer_or_hardcode_hour_close():
    ...
    assert product_skip_kinds("learning_lane_15m") == (
        ...
        "CLOCK-EXCEPT-FIRST-QUARTER",
        "CLOCK-EXCEPT-LAST-QUARTER",
    )
...
def test_hour_second_half_unused_then_clone_after_date(tmp_path):
    catalog = {
        "schema": 1,
        "lane": "learning_lane_15m",
        "kinds": [
    ...
    assert len(added) == 1
    assert added[0]["id"] == "F-CLOCK-HOUR-SECOND-HALF-30-45"
    assert added[0]["execution"] is False
    assert added[0]["params"]["skip_close_minutes"] == [30, 45]
    assert unused_legal_kinds(root=tmp_path) == []
    assert refuse_reason(
        {
            "kind": "CLOCK-HOUR-SECOND-HALF",
...
def test_hour_open_unused_then_clone_after_date(tmp_path):
    catalog = {
        "schema": 1,
        "lane": "learning_lane_15m",
        "kinds": [
    ...
    assert len(added) == 1
    assert added[0]["id"] == "F-CLOCK-HOUR-OPEN-0-15"
    assert added[0]["execution"] is False
    assert added[0]["params"]["skip_close_minutes"] == [0, 15]
    assert unused_legal_kinds(root=tmp_path) == []
    assert refuse_reason(
        {
            "kind": "CLOCK-HOUR-OPEN",
...
def test_hour_wrap_unused_then_clone_after_date(tmp_path):
    catalog = {
        "schema": 1,
        "lane": "learning_lane_15m",
        "kinds": [
    ...
    assert len(added) == 1
    assert added[0]["id"] == "F-CLOCK-HOUR-WRAP-0-45"
    assert added[0]["execution"] is False
    assert added[0]["params"]["skip_close_minutes"] == [0, 45]
    assert unused_legal_kinds(root=tmp_path) == []
    assert refuse_reason(
        {
            "kind": "CLOCK-HOUR-WRAP",
...
def test_intra_hour_unused_then_clone_after_date(tmp_path):
    catalog = {
        "schema": 1,
        "lane": "learning_lane_15m",
        "kinds": [
    ...
    assert len(added) == 1
    assert added[0]["id"] == "F-CLOCK-INTRA-HOUR-15-30-45"
    assert added[0]["execution"] is False
    assert added[0]["params"]["skip_close_minutes"] == [15, 30, 45]
    assert unused_legal_kinds(root=tmp_path) == []
    assert refuse_reason(
        {
            "kind": "CLOCK-INTRA-HOUR",
...
def test_except_first_quarter_unused_then_clone_after_date(tmp_path):
    catalog = {
        "schema": 1,
        "lane": "learning_lane_15m",
        "kinds": [
    ...
    farm_notebooks.append(
        {
            "id": "F-CLOCK-EXCEPT-HALF-HOUR-0-15-45",
            "kind": "CLOCK-EXCEPT-HALF-HOUR",
            "params": {"skip_close_minutes": [0, 15, 45]},
            "declared_at": "2026-09-10T22:48:00-04:00",
            "execution": False,
    ...
    assert unused == [
        {
            "kind": "CLOCK-EXCEPT-FIRST-QUARTER",
            "params": {"skip_close_minutes": [0, 30, 45]},
            "expected_skip_rate": 0.75,
        }
    ]
    added = date_notebooks(
        unused,
        declared_at="2026-09-10T23:36:00-04:00",
        root=tmp_path,
    )
    assert len(added) == 1
    assert added[0]["id"] == "F-CLOCK-EXCEPT-FIRST-QUARTER-0-30-45"
    assert added[0]["execution"] is False
    assert added[0]["params"]["skip_close_minutes"] == [0, 30, 45]
    assert unused_legal_kinds(root=tmp_path) == []
    assert refuse_reason(
        {
            "kind": "CLOCK-EXCEPT-FIRST-QUARTER",
...
def test_except_last_quarter_unused_then_clone_after_date(tmp_path):
    catalog = {
        "schema": 1,
        "lane": "learning_lane_15m",
        "kinds": [
    ...
    farm_notebooks.append(
        {
            "id": "F-CLOCK-EXCEPT-FIRST-QUARTER-0-30-45",
            "kind": "CLOCK-EXCEPT-FIRST-QUARTER",
            "params": {"skip_close_minutes": [0, 30, 45]},
            "declared_at": "2026-09-10T23:36:00-04:00",
            "execution": False,
    ...
    assert unused == [
        {
            "kind": "CLOCK-EXCEPT-LAST-QUARTER",
            "params": {"skip_close_minutes": [0, 15, 30]},
            "expected_skip_rate": 0.75,
        }
    ]
    added = date_notebooks(
        unused,
        declared_at="2026-09-10T23:57:00-04:00",
        root=tmp_path,
    )
    assert len(added) == 1
    assert added[0]["id"] == "F-CLOCK-EXCEPT-LAST-QUARTER-0-15-30"
    assert added[0]["execution"] is False
    assert added[0]["params"]["skip_close_minutes"] == [0, 15, 30]
    assert unused_legal_kinds(root=tmp_path) == []
    assert refuse_reason(
        {
            "kind": "CLOCK-EXCEPT-LAST-QUARTER",
