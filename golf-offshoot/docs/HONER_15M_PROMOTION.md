...
If the exam parks or scores dead: notebook closed. Compositor stays dark. Factory `decide()` unchanged. A new family is Lab `HONER-FAMILY-AMEND` → Operator RUN-ONLY → later Critic, not a tape sort.
