...
3. `/workspace/illustrator_ops/golf_offshoot/` if that directory exists
4. Repo fallback `golf-offshoot/docs/viz/golf_offshoot_dryrun_2026-09-07/`
5. `golf-offshoot/data/viz/` (documented hook location; may be empty)
...
See also [Operator Guide](OPERATOR_GUIDE.md#15-operator-shell-phase-1).
