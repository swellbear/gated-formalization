...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default="demo",
        choices=["demo", "board", "explain", "strategy", "ingest", "calibrate", "pressure-test", "live", "watch", "shadow", "shell", "paper-export", "paper-ledger", "paper-deposit", "paper-withdraw", "paper-settle", "paper-fill", "compare-replay", "hub", "lane-15m", "learn-15m", "learn-15m-runner", "digest-15m", "observability-export", "honer-15m", "golf-kalshi", "publish-hub"],
    )
    ...
    parser.add_argument(
        ...
        help="operator_surface selector (hub). Exact lane=golf|learning_lane_15m only. No bare 15m alias. Default golf.",
    )
    parser.add_argument(
        "--serve",
        action="store_true",
...
def _cmd_golf_kalshi(args) -> int:
    """Kalshi golf paper gym. Does not start or kill 15m PaperWatch."""
    from golf_offshoot.golf_kalshi.watch import run_watch_forever
