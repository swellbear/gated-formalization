...
|-------------------|-------------|------------------|--------|-------|-----|-------------|------|
| **R-F-SKILL** · oil-futures | Next-session CL log-return vs last-settlement RMSE (F-CC + F-ON/F-DAY) | `name horse …` (**different** recipe) on Yahoo; do **not** add year/6-month/day after DJT scores; do **not** retune the lexicon; live CME **only if** **L-SCREEN-Y-PROMOTE** fires | med once a horse is named | high | DJT no survivor; FADE small F-DAY / F-CC tie; pretell hunt no survivor; CAL tiny 500 / fails 750; VOL and H-LAG lost on F-CC | **pursue** | DJT discovery F-CC both tie 0; H-KS not run; **not** skill-met |
