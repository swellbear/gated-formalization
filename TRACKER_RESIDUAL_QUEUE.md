...
**Last refreshed:** 2026-08-17 (oil-futures **hard stop (residuals live)**: **R-F-SKILL** **pursue** (next horse on Yahoo; H-LAG failed **L-SCREEN-Y-PROMOTE**); **R-LIVE-STANDIN** executed (promote only if F-CC gate fires); **R-V-VALUE** park-until-trigger (**V2 named**, book unnamed); **R-F-COMBO** park-until-trigger. Park-90d quarterly still due ~2026-11-12 — this refresh does **not** re-churn that card.)  
...
**Note:** CoreWeave **hard stop sealed**; Zitron Nvidia $500B **hard stop sealed** (restart frame; Squawk/D-APPEAR OUT). Prior Squawk-stand-in R-* rows remain historical/drop. FOMC parent closeout intact; R-FML-INDEP **executed** (SPF Q2 2026; not established; not a refute). Oil-futures **hard stop (residuals live)**; Yahoo `CL=F` stand-in; **L-SCREEN-Y-PROMOTE**; R-F-SKILL **pursue** (H-LAG failed promote gate; next horse on Yahoo); R-LIVE-STANDIN **executed** (live CME only if F-CC gate fires).
...
|-------------------|-------------|------------------|--------|-------|-----|-------------|------|
| **R-F-SKILL** · oil-futures | Next-session CL log-return vs last-settlement RMSE (F-CC + F-ON/F-DAY) | `name horse …` on Yahoo; live CME **only if** **L-SCREEN-Y-PROMOTE** fires | med once a horse is named | high | H-LAG scored, lost on F-CC (does not promote) | **pursue** | H-LAG last-500 F-CC 0.02888 vs 0 0.02869; H-KS not run; **not** skill-met |
