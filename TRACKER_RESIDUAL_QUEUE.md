...
|-------------------|-------------|------------------|--------|-------|-----|-------------|------|
| **R-F-SKILL** · oil-futures | Next-session CL log-return vs last-settlement RMSE (F-CC + F-ON/F-DAY) | `name horse …` (**different** recipe) on Yahoo; do **not** remix gap horses; live CME **only if** **L-SCREEN-Y-PROMOTE** fires | med once a horse is named | high | FADE small F-DAY / F-CC tie; pretell hunt no survivor; CAL tiny 500 / fails 750; VOL and H-LAG lost on F-CC | **pursue** | Confirm F-DAY 0.026584 vs 0 0.026634; H-KS not run; **not** skill-met |
