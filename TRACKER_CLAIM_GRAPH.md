...
| APP-OIL-FT | Application | `2026-08_oil-futures-predictive-model` | **Hard stop (residuals live)**; Rank 4 split; D-EXIST-MET-FT; **L-SCREEN-Y-PROMOTE**; **H-LAG-WF** scored (F-CC loss; does not promote); **V-COST-V2**; Amb 1.0; F-SKILL/V-VALUE not established; **R-F-SKILL** pursue; V-SRC leave unnamed; UX/CX/CR **declined** |
