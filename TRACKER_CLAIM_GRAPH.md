...
| APP-OIL-FT | Application | `2026-08_oil-futures-predictive-model` | **Hard stop (residuals live)**; Rank 4 split; D-EXIST-MET-FT; **L-HUNT-SPOT-LOGIT** discovery beat / confirm lose (queue empty); **L-HUNT-SPOT-CROSS** WTI fail / Brent tiny 250 ≠ met; **L-HUNT-SPOT-INV** no survivor; **L-HUNT-SPOT-TREND** no survivor; **L-HUNT-COT** no survivor; Amb 1.0; **R-F-SKILL** pursue; **R-SPOT-TREND** executed (not established); UX/CX/CR **declined** |
