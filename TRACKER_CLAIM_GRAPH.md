...
| APP-GWT | Application | `2026-08_llm-global-workspace-consciousness` | Live remnant Provisional-stable; Amb ≈ 2.5; **LLM remnant string** definitional locks **complete**; R-REPL not authorized |
...
| APP-OIL-FT | Application | `2026-08_oil-futures-predictive-model` | **Hard stop (residuals live)**; Rank 4 split; D-EXIST-MET-FT; **H-LAG-WF** scored (F-CC loss); **V-COST-V2**; Amb 1.0; F-SKILL/V-VALUE not established; **R-F-SKILL** pursue; V-SRC leave unnamed; UX/CX/CR **declined** |
...
- `APP-OIL-FT` **hard stop (residuals live)** (2026-08-17): Rank 4 nested split; D-EXIST-MET-FT; H-LAG-WF scored and lost on F-CC; H-KS not run; **V-COST-V2**; Amb 1.0; Amb ≠ clearance; Phase 2 not entered; UX/CX/CR **declined**.
